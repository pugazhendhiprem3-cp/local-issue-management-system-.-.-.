...
public class UserService 
{
    ...
    if (dto.getRole() != null && !dto.getRole().trim().isEmpty()) {
        ...
        user.setRole("USER"); // Default fallback if registration form doesn't pass a role
    }
    ...
    System.out.println("Entered Email: " + dto.getEmail());
    ...
    ); // the place where user entered password and db password gets compared internally 
