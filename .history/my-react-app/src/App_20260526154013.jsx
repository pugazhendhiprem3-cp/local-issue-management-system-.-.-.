      ...
      <div className="min-h-screen bg-slate-900 text-white">
        <nav className="p-4 bg-slate-950 border-b border-slate-800 flex justify-between items-center shadow-md">
          <div className="flex gap-6 items-center">
            ...
            {/* ✅ Show Report Issue ONLY if logged in and not ADMIN */}
            ...
            {/* ✅ Authority Dashboard for ADMIN only */}
            {role === "ADMIN" && (
              <Link
                to="/admin"
                className="text-slate-300 font-semibold hover:text-emerald-400 transition-colors"
          ...
          <div className="flex gap-3 items-center">
            {isAuthenticated ? (
              ...
              <>
                ...
                <Link to="/signup" className="bg-emerald-700 hover:bg-emerald-600 text-white font-semibold py-1.5 px-4 rounded-xl transition duration-200 text-sm">
                  📝 Sign Up
                </Link>
              </>
            )}
        ...
        <div className="container mx-auto px-4 py-6">
          <Routes>
            ...
            <Route path="/create-issue" element={role !== "ADMIN" ? <CreateIssue /> : <Home />} />
