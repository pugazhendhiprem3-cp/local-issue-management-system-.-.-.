        ...
        <div className="flex justify-center items-center min-h-[80vh]">
            ...
            >
                ...
                <div>
                    ...
                    <label className="block text-sm font-semibold text-s-300 mb-1.5">
                        Issue Title
                    </label>
                    ...
                    <input
                        ...
                        required
                        className="w-full p-3 rounded-xl bg-slate-900 border border-slate-800 focus:outline-none focus:border-emerald-800 text-slate-100"
                    />
