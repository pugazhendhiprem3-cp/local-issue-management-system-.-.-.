...
import com.cp.localissue.service.CustomUserDetailsService; // ✅ This was the missing import
...
public class SecurityConfig {
    ...
    public AuthenticationProvider deprecatedAuthenticationProvider() {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/uploads/**", "/serve/**", "/api/image/**").permitAll()
